...
INPUT_CSV = os.path.join(BASE_DIR, "data", "Companies", "CES_TEST_CATEGORIZED.csv")
OUTPUT_DIR = os.path.join(BASE_DIR, "data", "Companies", "TEST_RESULTS")
...
def main():
    ...
    for idx, row in df.iterrows():
        ...
        description = row.get('Full_Summary', '')
